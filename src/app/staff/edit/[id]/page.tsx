...
export default function EditStaffPage() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      setError(
        "Login or Staff ID was not found."
      );
      ...
      <section className="mx-auto max-w-5xl px-4 py-6">
        ...
        >
          ...
          <SectionCard
            ...
            description="Update staff, work mode and office assignment."
          >
          ...
          <SectionCard
            ...
            description="Staff address and contact information."
          >
          ...
          <SectionCard
            title="⚙️ Account Status"
            description="Login and active status."
          >
